...
export class EmailService {
  ...
  private emailList = signal<Email[]>([
    ...
    {
      id: crypto.randomUUID(),
      message: 'Hello Benedict, I hope you\'re having a great day. I wanted to follow up on the presentation materials you sent over. By the way, did you catch the game last night? What an incredible finish! Oh, and before I forget, my sister is getting married next month and I\'d love for you to attend if you\'re free.',
      sendedAt: new Date(),
    ...
    {
      id: crypto.randomUUID(),
      message: 'Hi Teresa, I hope this message finds you in good spirits. I\'ve been meaning to ask you about your recent trip to Japan. How was it? I\'m planning a vacation myself and could use some recommendations. Also, I came across an interesting article about sustainable living that I thought you might enjoy. Let me know if you\'d like me to forward it to you.',
      sendedAt: new Date(),
    ...
    {
      id: crypto.randomUUID(),
      message: 'Dear Borja, I hope you\'re doing well. I wanted to apologize for missing our meeting last Thursday. My car broke down on the way to the office, and it was a whole ordeal. On a brighter note, I finished reading that book you recommended, and it was fantastic! We should grab lunch soon and discuss it.',
      sendedAt: new Date(),
    ...
    {
      id: crypto.randomUUID(),
      message: 'Dear Borja, I hope this email finds you in good spirits. I wanted to discuss the possibility of rescheduling our meeting next week. Something urgent has come up, and I may need to be out of town. On a lighter note, I finally watched that movie you recommended, and it was fantastic! The plot twists kept me on the edge of my seat. Also, how\'s your garden doing this season? I remember you mentioning you were trying to grow some exotic vegetables.',
      sendedAt: new Date(),
