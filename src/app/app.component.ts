...
export class AppComponent {
    ...
    ngOnInit(): void {
        this.meta.addTag({
            name: 'description',
            content: 'Ngx desktop is an Angular desktop client',
        });
        this.meta.addTag({ name: 'title', content: 'Ngx-desktop - Angular' });
        this.meta.addTag({
            name: 'keywords',
            content: 'angular, defer, typescript, desktop-rocket',
        });
        this.meta.addTag({ name: 'author', content: 'Borja Muñoz' });
        this.meta.addTag({
            property: 'og:image',
            content: 'assets/images/artic_monkeys.jpg',
        });
        this.meta.addTag({
            property: 'og:url',
            content: 'https://ngx-desktop.vercel.app/',
        });
        this.meta.addTag({ property: 'og:type', content: 'website' });
        this.meta.addTag({
            property: 'og:title',
            content: 'Ngx-desktop - Angular',
        });
        this.meta.addTag({
